...
namespace Campeonato_App.Models
{
    public class Jogo
    {
        ...
        public string selecaoCasaNome { get; set; }

        public string selecaoVisitanteNome { get; set; }

        public string bandeiraCasa { get; set; }
        
        public string bandeiraVisitante { get; set; }
